    				...
    				<div class="span6">
						<form action="#" method="post" name="frmPreCadCom">
							<div class="input_fields_wrap">
							    	<input type="text" name="listCom[]">
							    	<a class="add_field_button"><img alt="Adicionar Comunidade" src="core/imagem/add.png" width="30px;"></a>
							</div>
							<br>
							<input class="btn" type="submit" value="Enviar" name="btnEnviar">
						</form>
	...
	$(document).ready(function() {
		    ...
		    $(add_button).click(function(e){ //on add input button click
		        ...
		        if(x < max_fields){ //max input box allowed
		            ...
		            $(wrapper).append('<div><input type="text" name="listCom[]"/><a href="#" class="remove_field"><img alt="Adicionar Comunidade" src="/core/imagem/remove.png" width="25px;"></a></div>'); //add input box
		        }
		    });

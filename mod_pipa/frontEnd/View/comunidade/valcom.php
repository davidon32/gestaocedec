...
?>
		<!-- INICIO DO CORPO-->
						...
						<a class="btn btn-primary" href="?modulo=pipa&controller=pipa&action=pmdaCom&a=adm">Voltar</a>
						</form>
						<br>
						<?php
							...
							if(($btn == "Pesquisar") && !empty($nomMunicipio)){
								...
								if(!empty($id_municipio)){	
									...
									foreach ($listCom as $value) {
										...
										print "<td $preCad>";
										print ($value['tipo_cad'] =="pre") ? "<a href='?modulo=pipa&controller=pipa&action=alteraComunidade&id=".$value['id_comunidade']."&idMun=".$id_municipio."' id='btnEfetiva' title='Editar Nome Comunidade'><img src='/core/imagem/editar.png' width='30px;'></a>

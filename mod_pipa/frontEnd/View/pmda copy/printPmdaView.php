<?php include_once 'core/include.php';
	...
	/* 	$login = new Login();
		...
		//$id_municipio = isset($_COOKIE['session']['seguranca']['id_municipio']) ? $_COOKIE['session']['seguranca']['id_municipio'] :"";
  	...
  	<div class="container-fluid">
  		...
  		<div class="col-md-3 text-right" id="btnVoltar">
  			<?php
  				...
  				$voltarAdm = '<a href="index.php?modulo=pipa&controller=pipa&action=pesquisaPmda" class="btn btn-primary">Voltar</a>';
  		...
  		<div class="col-md-12">
  			<table class="table table-bordered">
  				...
  				<tr>
  					...
  					<td><b>Tel Gab. :<b><?=$dadosPref['tel'];?></td>
  					<td><b>Tel Celular :</b><?=$dadosPref['cel'];?></td>
  				...
  				<tr>
  					...
  					<td><b>Fax :</b> <?=$dadosPref['cel_pref'];?></td>

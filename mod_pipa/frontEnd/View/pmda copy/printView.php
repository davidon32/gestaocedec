...
?>
						...
						<div class="span6 text-center">
							<br>
							<a class="btn btn-primary" href="?modulo=pipa&controller=pipa&action=printPmda&param=<?=$id_pmda.'&a='.rand().'&mun='.$id_municipio;?>">Visualizar PMDA</a>
							<a class="btn btn-primary" href="?modulo=pipa&controller=pipa&action=printPmdaMapa&param=<?=$id_pmda.'&mun='.$id_municipio;?>">Visualizar Mapa PMDA</a>
						...
						<p style="text-align:center"><b>Anexo do PMDA formato PDF</b></p>
							...
							<?php $anexo = new AnexoPmda(); 
						  		...
						  		foreach ($listAnexo as $value) {
						  			...
						  			print "<a style='text-decoration:none;'href="."/anexo/".$pmda->previewAnexo($value['id'])."><img src='/core/imagem/pdf.png'>".$pmda->previewAnexo($value['id'])."</a><br>";

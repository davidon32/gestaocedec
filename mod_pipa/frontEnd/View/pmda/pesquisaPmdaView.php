                    	   ...
                    	   if($btn == 'Pesquisar') {
							   ...
							   if($opcao == "municipio") {
								   ...
								   foreach ($dadosMun as $value) {
									   print "<tr>
									   <td style='background-color:#E6E6E6;'><a href='?token=".hash('sha256', md5(VERSAO))."&ac=&modulo=pipa&controller=pipa&action=pesquisaPmda&idmun=".$value['id_municipio']."'>".$value['nome']."</a></td>
									   <td style='background-color:#E6E6E6;'><a href='?token=".hash('sha256', md5(VERSAO))."&ac=&modulo=pipa&controller=pipa&action=pesquisaPmda&idmun=".$value['id_municipio']."'><img src='core/imagem/search.png' width=25px;></a></td>
									   </tr>";
									}
									print "</table>";

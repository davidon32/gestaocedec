...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#tab_comunidade").click(function () {
            ...
            $.ajax({
                url: 'mod_pipa/frontEnd/View/pmda/selPonto.php',
                type: 'POST',
                data: dados,
                success: function (response) {
                ...
                success: function (response) {
                    ...
                    if (response == "sucesso") {
                        ...
                        if (
                            ...
                            $.ajax({
                                url: '/mod_pipa/frontEnd/View/pmda/acoes.php',
                                type: 'POST',
                                data: dados,
                                success: function (response) {
                                    alert('Dados gravados com Sucesso !');
                ...
                success: function (response) {
                    if (response == "sucesso") {
                        ...
                        if (
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '/mod_pipa/frontEnd/View/pmda/ponto.php',
                                data: dados,
                                success: function (response) {
                    ...
                    if (response == "sucesso") {
                        ...
                        if (
                            ...
                            if (result == true) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/mod_pipa/frontEnd/View/pmda/comunidade.php',
                                    data: dados,
                                    //dataType : 'json',
                                    success: function (response) {
                                        alert("Registro alterado com sucesso !");
                ...
                success: function (response) {
                    if (response == "sucesso") {
                        ...
                        if (
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '/mod_pipa/frontEnd/View/pmda/representante.php',
                                data: dados,
                                success: function (response) {

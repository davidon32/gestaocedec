    ...
    <div class="col-md-12">
        ...
        <div class="tabbable" id="tabs-166211">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class=""><a href="#panel-municipio" role="tab" data-toggle="tab" id="tab_municipio" title="Informações sobre ISS">ISS</a></li>
                <li class=""><a href="#panel-compdec" role="tab" data-toggle="tab" id="tab_compdec" title="Dados do Compdec">COMPDEC</a></li>
                <li class=""><a href="#panel-ponto" role="tab" data-toggle="tab" id="tab_ponto" title="Informações Sobre o Ponto de Captação de Água">Ponto Captação</a></li>
                <li class=""><a href="#panel-comunidade" role="tab" data-toggle="tab" id="tab_comunidade" title="Informações sobre as Comunidade que serão Atendidas">Locais de Distribuição</a></li>
                <li class=""><a href="#panel-representante" role="tab" data-toggle="tab" id="tab_representante"></a></li>
                <li class=""><a href="#panel-acoes" role="tab" data-toggle="tab" id="tab_acoes" title="Informações sobre as Ações de resposta a Seca no Município">Ações de Resposta</a></li>
                <li class=""><a href="#panel-anexo" role="tab" data-toggle="tab" id="tab_anexo" title="Documentos a serem anexados no Processo">Anexos</a></li>
                <li class=""><a href="#panel-instrucao" role="tab" data-toggle="tab" id="tab_instrucao" title="Instruções de Preenchimento">Instruções</a></li>
            </ul>
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane in active" id="panel-inicio">

                    <div>
                        <button class="btn btn-primary" title="Voltar Menu" id="idVoltarMenu">Voltar</button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="col-xs-2 form-group">
                                    <label>Recolhe ISS ?</label> <i class="fa fa-asterisk" style="color:red"></i>
                                    <select class="form-control" id="selCobraIss" name="selCobraIss">
    ...
    $(document).ready(function () {
        ...
        $("#fileAnexo").change(function () {
            ...
            if (tamanho[0]['size'] > 1999353) {
                $("#btnAddAnexo").attr("disabled", true);
                $("#btnAddAnexo").attr("title", "Seu arquivo é maior que 2mb tente reescanear com a opção compactar !");
                Swal.fire({
                    icon: 'error',
                ...
                $("#btnAddAnexo").attr("disabled", false);
            }
...
//                $("#txtNumLei").prop('readonly', false);
        ...
        $("#tab_comunidade").click(function () {
            ...
            var id_pmda = getUrlVars()['param'];
            //alert(id_pmda);
            $("#tblComunidadePmda").load("/mod_pipa/frontEnd/View/pmda/comunidade.php?param=" + id_pmda);

            $.ajax({
                url: 'mod_pipa/frontEnd/View/pmda/selPonto.php?v=<?= md5(VERSAO) ?>',
                type: 'POST',
                data: dados,
                success: function (response) {
                ...
                success: function (response) {
                    ...
                    if (response == "sucesso") {
                        ...
                        if (
                            ...
                            $.ajax({
                                url: '/mod_pipa/frontEnd/View/pmda/acoes.php?v=<?= md5(VERSAO) ?>',
                                type: 'POST',
                                data: dados,
                                success: function (response) {
                                    alert('Dados gravados com Sucesso !');
                    ...
                    if (response == "sucesso") {
                        ...
                        if (($('#txtAnexoDesc').val() == "") && ($('#fileAnexo').val() == "")) {
                            ...
                            if (extensao.toLowerCase() == 'pdf' ||
                                ...
                                $.ajax({
                                    url: '/mod_pipa/frontEnd/View/pmda/valida_anexo.php?v=<?= md5(VERSAO) ?>',
                                    type: 'POST',
                                    data: formData,
                ...
                success: function (response) {
                    if (response == "sucesso") {
                        ...
                        if (
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '/mod_pipa/frontEnd/View/pmda/ponto.php?v=<?= md5(VERSAO) ?>',
                                data: dados,
                                success: function (response) {
                    ...
                    if (response == "sucesso") {
                        ...
                        if (
                            ...
                            if (result == true) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: '/mod_pipa/frontEnd/View/pmda/comunidade.php?v=<?= md5(VERSAO) ?>',
                                    data: dados,
                                    //dataType : 'json',
                                    success: function (response) {
                ...
                success: function (response) {
                    if (response == "sucesso") {
                        ...
                        if (
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '/mod_pipa/frontEnd/View/pmda/representante.php?v=<?= md5(VERSAO) ?>',
                                data: dados,
                                success: function (response) {

...
<?php include_once "template/page/corpoHeader.php";?>
        ...
        <p style="text-align:center;" id="titulo"><h4>Listagem Posição PMDA</h4></p>
						...
						<a class="btn btn-primary" href="?modulo=pipa&controller=pipa&action=index">Voltar</a>
						<?php
                    	   ...
                    	   if($btn == 'Pesquisar') {
							   ...
							   if($opcao == "municipio") {
								   ...
								   print "<tr>
											   ...
											   <th style='text-align:center;background-color:#BDBDBD;'>AÇÃO</th>
											<tr>";
								   
								   foreach ($dadosMun as $value) {
									   print "<tr>
									   <td style='background-color:#E6E6E6;'><a href='?token=".hash('sha256', md5(VERSAO).date('dmY'))."&ac=&modulo=pipa&controller=pipa&action=pesquisaPmda&idmun=".$value['id_municipio']."'>".$value['nome']."</a></td>
									   <td style='background-color:#E6E6E6;'><a href='?token=".hash('sha256', md5(VERSAO).date('dmY'))."&ac=&modulo=pipa&controller=pipa&action=pesquisaPmda&idmun=".$value['id_municipio']."'><img src='core/imagem/search.png' width=25px;></a></td>
									   </tr>";
									}
									print "</table>";
								...
								if(!empty($dados)){
									...
									print "<table class='table table-condensed tblcedec' style='width:100%; font-size:9pt;'>";
									print "<tr>
									...
									if($opcao == "geral"){
		                    	       ...
		                    	       foreach ($dados as $key => $value) {
		                    	       	...
		                    	       	if(($value['status'] == 4) && (!$listagem)) {
											...
											print "<tr>";
											print "<td><img src='core\imagem\add1.png' width='100%' id='versoesPmda' name='versoesPmda' title='versões PMDA'></td>";
											...
											if($listagem){
												...
												print "<td>".$pmda->status($value['status'])."</td>";
												$alteraStatus = "";
			                    	           ...
			                    	           print "<td ".$homologado."><select class='form-control' id='selStatus".$value['id_pmda']."' data='".substr($busca, 0, -8)."'>
												...
												print "|<a href='?modulo=pipa&controller=pipa&action=historicoMsg&id_pmda=".$value['id_pmda']."' id='list_msg' name='list_msg' title='Historico de Mensagens do PMDA nº ".$protocolo."'><img src='core/imagem/notas.png'></a></td>";
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<textarea class="form-control span6" type="text" name="txtMsg" id="txtMsg" rows="5" cols="5"/></textarea>

...
$geraLote = $_calculo->geraLote($mesNum, $dados['ano']);
		...
		<div class="row-fluid">
			...
			<div class="span3">
				...
				<form action="secao.php?secao=conta&acao=previaConta" method="POST" name="frm_calcula" id="frm_calcula">
					...
					<label>Pessoa</label>
					<input type="text" name="pessoa" id="pessoa" value="<?php print $dados['pessoa'];?>" readonly="readonly"/>
					...
					<label>Mês</label>
					<input type="text" name="mes" id="mes" value="<?php print $dados['mes'];?>" readonly="readonly" />
					...
					<label>Km</label>
					<input type="text" name="km" id="km" size="10" value="0" onblur="valorFinal()">

					<label>Lote</label>
					<input type="text" name="lote" id="lote" size="5" value="<?php print $geraLote[0];?>" readonly="readonly" />
					...
					<input class="btn btn-primary" type="button" name="calcular" id="calcular" value="Calcular" onclick="Confirmacao();" />

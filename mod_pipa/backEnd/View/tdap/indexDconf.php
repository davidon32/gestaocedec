...
<div class="col-md-12">
    ...
    <div class="col-md-6 text-center">
        <a href="<?= FuncaoBase::geraLink("pipa","pipa", "decIndex")?>"><img width="100" src='/core/imagem/dConf.png' title='Execução e Controle de Declaração de Conformidade'></a><br><br>Declaração de Conformidade
    </div>

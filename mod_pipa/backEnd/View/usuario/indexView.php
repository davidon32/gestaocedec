...
<div class="col-md-12">
  <br><br>
	<a class='btn btn-primary' href='?token=<?=hash('sha256', md5(VERSAO).date('dmY'));?>&ac=itn&modulo=pipa&controller=pipa&action=caduser' title='Cadastro de Usuários COMPDEC'>Cadastro de Usuários (COMPDEC)</a><br>	<br>					

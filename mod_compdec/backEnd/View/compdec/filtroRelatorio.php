...
<div class="col-md-12">
    ...
    <form action="?token=<?= hash('sha256', md5(VERSAO) . date('dmY')); ?>&ac=itn&modulo=compdec&controller=compdec&action=relatorio" method="POST" name="frm_filtro">
        ...
        <div class="col-md-4 inline">
            <input type="radio" value="0" name="rb_filtro" id="rb_associacao"> Compdec por Associação<br><br>
            <input type="radio" value="1" name="rb_filtro" id="rb_endereco"> Compdec por Endereço<br><br>
            <input type="radio" value="2" name="rb_filtro" id="rb_regiao"> Compdec por Região do Estado<br><br>
            <input type="radio" value="3" name="rb_filtro" id="rb_existente"> Compdec Existente/Inexistentes<br><br>
        </div>
        <div class="col-md-4 inline">
            <input type="radio" value="4" name="rb_filtro" id="rb_data"> Relatório por Data Criação da COMPDEC<br><br>
            <input type="radio" value="5" name="rb_filtro" id="rb_desenvolvimento"> Compdec por Região de Desenvolvimento<br><br>
            <input type="radio" value="6" name="rb_filtro" id="rb_resumo"> Resumo<br><br>
            <input type="radio" value="7" name="rb_filtro" id="rb_impressaoLivro"> Impressão Caderno Compdec<br><br>
        </div>
        <div class="col-md-4 inline">
            <input type="radio" value="8" name="rb_filtro" id="rb_listaEmail"> Envio Email em Lote<br><br>
            <input type="radio" value="9" name="rb_filtro" id="rb_listaOutlook"> Separação envio OutLook CA<br><br>
            <input type="radio" value="10" name="rb_filtro" id="rb_listaRegiaoDC"> Lista Por Região de DEFESA CIVIL<br><br>
        </div>
</div>
<div class='col-md-12'>
    <br><br>
    ...
    <div class="span4 divRegiaoDC">
        <!-- sub seção de relatório -->
        <legend>Região de DEFESA CIVIL</legend>
        <?php $_regiao->comboRegiaoDC(); ?>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#rb_listaRegiaoDC").change(function () {

            $(".divRegiaoDC").show("slow");
            $(".divAssociacao").hide();
            $(".divRegiao").hide();
            $(".divData").hide();

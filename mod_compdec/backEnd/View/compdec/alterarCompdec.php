			...
			<div role="tabpanel" class="tab-pane" id="panel-dados">
				...
				<tr>
					...
					<label>Nome Município :</label>
						...
						<br />
                                                <input class="form-control" type="hidden" name="id_municipio" id="id_municipio" value="<?php print $_dados[0]['id_municipio']; ?>" maxlength="5"/>
					...
					<div class="row">
						...
						<div class="row">				
							<div class="col-md-6">
                                                            Número Portaia:<input class="form-control" type="text" name="txt_num_portaria" id="txt_num_portaria" value="<?php print $_dados[0]['num_portaria'];?>" maxlength="10"> &nbsp;&nbsp;
							</div>
							<div class="col-md-6">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<label>Quantos integrantes ?</label>
                                                                <input class="form-control" type="text"	name="txt_qtd_efetivo" id="txt_qtd_efetivo"	value="<?php print $_dados[0]['qtd_efetivo'];?>" maxlength="1" >
							</div>		
					...
					<div role="tabpanel" class="tab-pane" id="panel-dados2">
										...
										<div class="radio">
											<label>
												...
												Sim
                                                                        ...
                                                                        <label>Data do Curso :</label> <input class="form-control" type="text" name="txt_dt_curso" id="txt_dt_curso" value="<?php print DataMysql::dataVisual($_dados[0]['dt_curso_capac']);?>" maxlength="10">
									<br>
								...
								<br>
									...
									<input class="" type="checkbox" name="ck_curso_sco" id="ck_curso_sco" value="1" <?php print ($_dados[0]['curso_sco'] == 1) ? 'checked="checked"' : '';?> />&nbsp;&nbsp;Possui Curso de SCO.<br>
                                                                        ...
                                                                        Data Curso <input class="form-control" type="text" name="dt_curso_sco" id="dt_curso_sco" value="<?php print DataMysql::dataVisual($_dados[0]['dt_curso_sco']);?>" maxlength="10"><br>
									...
									<input class="" type="checkbox" name="ck_particip_workshop" id="ck_particip_workshop" value="1" <?php print ($_dados[0]['particip_workshop'] == 1) ? 'checked="checked"' : '';?> />&nbsp;&nbsp;Participou de WorkShop<br>
                                                                        ...
                                                                        Data <input class="form-control" type="text" name="dt_partic_workshop" id="dt_partic_workshop" value="<?php print DataMysql::dataVisual($_dados[0]['dt_partic_workshop']);?>" maxlength="10">

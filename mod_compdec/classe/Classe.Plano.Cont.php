...
class Plano
{
	...
	public function listaPlano($id_municipio){
		...
		$sql = "select file_plano, versao, dt_upload, id from com_plano_upload where id_municipio = :id_municipio
		order by id";
    ...
    public function gravaUpload($dados)
    {
        ...
        $sql = "INSERT INTO com_plano_upload (id_municipio, id_plano, file_plano, versao, dt_upload)
										VALUES (:id_municipio,
												:id_plano,
												:filePlano,
												:versao,

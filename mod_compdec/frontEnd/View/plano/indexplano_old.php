...
<?php
	...
	$id_pmda = isset($_GET['param']) ? $_GET['param'] :"";
	    ...
	    if(!empty($id_pmda)){
	    	...
	    	$pageSession['session']['seguranca']['id_pmda'] = $id_pmda;
	    }
                ...
                <br><br>
					...
					<?php
						...
						foreach ($lista as $key => $value) {
							...
							print "<a href=\"?modulo=compdec&controller=plano&action=vupload&id=".$value['id']."\">Plano Versao ".$value['versao']." -  Data: ".$value['dt_upload']."</a>";

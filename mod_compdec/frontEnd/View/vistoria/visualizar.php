            ...
            <br>
                ...
                <br>
                    ...
                    <div class="" id="editor">
                        ...
                        RELATÓRIO DE VISTORIA DE ATENDIMENTO EMERGENCIAL Nº<?= $dados->numero ?>

                        1. Proprietário/Morador: <i><?= $dados->prop ?>
                            Endereço do local da vistoria: Município: <?= $dados->endereco ?></i>
                        Contato/Telefone: <?= $dados->tel ?></i>
                        Data da vistoria: Tipo da Ocorrência: Tipo de Imóvel:

                        2. CONDIÇÃO DO LOCAL (marcar sim ou não para cada anomalia visualizada)</p>
                        ...
                        3. CARACTERIZAÇÃO DO LOCAL (Relatar qual a condição do terreno onde está a edificação)

                        <?= $dados->caracterizacao ?>
                        4. PARECER/CONCLUSÃO

                        <?= $dados->parecer ?>
                        RECOMENDAÇÃO/CONSIDERAÇÃO
                        Providências imediatasMedidas para recuperação<?= $dados->rec_medidas_recuperacao ?>
                        6. CONSIDERAÇÕES FINAIS7. RESPONSÁVEL/VISTORIADOR

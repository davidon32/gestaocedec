...
$vistorias = vistoriaController::listagem_geral();
...
<div class="col-md-6">
    ...
    <table class="table table-bordered table-condensed table-striped" >
        <tr>
            ...
            <th class="col-md-1">Data Vistoria</th>
    ...
    foreach ($vistorias as $key => $vistoria) {
        ...
        print "<tr>";
        print "<td>".$vistoria['numero']."</td>";
        print "<td>".$vistoria['dt_vistoria']."</td>";
        print "<td>".$vistoria['prop']."</td>";
        print "<td>".$vistoria['endereco']."</td>";
        print "</tr>";

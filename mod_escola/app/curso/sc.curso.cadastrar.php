    ...
    <div class="container">
        ...
        ?>
					...
					<div class="span9 fdo_corpo">
							<br />
							    <form action="secao.php?secao=curso&acao=cadastrar" method="POST" name="frmCadastraCurso">
								    <fieldset>
									    <legend>Cadastro Curso</legend>
									    <label>Nome</label>
									    <input class="input-xlarge" type="text" placeholder="" name="nomeCurso">

									    <label>Sigla</label>
									    <input class="input-xlarge" type="text" placeholder="" name="sigla">
									    <span class="help-block"></span>
									    
									    <button type="submit" class="btn btn-primary" name="cadastrar" value="cursoCadastrar" v>Cadastrar</button>
								    </fieldset>
								</form>

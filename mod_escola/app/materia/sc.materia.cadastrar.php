    ...
    <div class="container">
        ...
        ?>
					...
					<div class="span9 fdo_corpo">
							<br />
							    <form action="sistema/controller/valida.materia.cadastrar.php" method="POST" name="frmMateriaCad">
								    <fieldset>
									    <legend>Cadastro Matéria</legend>
									    <label>Nome</label>
									    <input class="input-xlarge" type="text" placeholder="" name="nome">

									    <label>Coordenador</label>
									    <input class="input-xlarge" type="text" placeholder="" name="coordenador">

									    <label>Carga Horária</label>
									    <input class="input-xlarge" type="text" placeholder="" name="cargaHoraria">

									    <label>Auxiliar</label>
									    <textarea placeholder="" name="auxiliar"></textarea>

									    <span class="help-block"></span>

									    <button type="submit" class="btn btn-primary" name="cadastrar" value="materiaCadastrar">Cadastrar</button>
								    </fieldset>
								</form>

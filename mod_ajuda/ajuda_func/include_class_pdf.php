<?php 
include_once PATH.'/core/system/config/config.inc.php';
//include_once PATH.'/core/classe/Classe.PDO.php';
//include_once PATH.'/plugins/fpdf/fpdf.php';
include_once PATH.'/mod_ajuda/classe/Classe.Liberacao.php';
include_once PATH.'/core/classe/Classe.DataMysql.php';
...
//include_once SISTEMA.'/mod_ajuda/func/rodape.php';
?>
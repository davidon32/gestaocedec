...
include_once "template/page/headerPageSimples.php";
    ...
    if($_opcao == "transferir") {
        ...
        //var_dump($_material[0][0],$_txt_dep_destino );
        if(count($_material) > 0){
            # Depositos iguais origem e destino
            if($_material[0][0] != $_txt_dep_destino) {
                ...
                print "alert('Infelizmente, você está tentando fazer uma transferencia do "
                . "Deposito ". Deposito::PegaNomeDeposito($_material[0][0])." para o mesmo Deposito Avancado, gentileza Corrigir !');";

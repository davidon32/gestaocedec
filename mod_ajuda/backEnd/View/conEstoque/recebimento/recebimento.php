...
*	Função       :  Tela para recebimento de materiais transferidos
*
*******************************************************************************************/
...
$_tranferencia = new TransferenciaMaterial();
	...
	<div class="container">
		...
		<div class="row-fluid">
			...
			<div class="span9 fdo_corpo">
				<legend>Receber Materiais Transferidos entre Depósitos</legend>
				<table border="0" id="" class="table" cellspacing="0" cellpadding="0" align="center">
					<tr>
					</tr>
					<tr>
						<td valign="top" class=""><?php $_tranferencia->ReceberMaterial($_SESSION['seguranca']['id_deposito'],
                                                                                        $_SESSION['seguranca']['nivel']);?></td>
					</tr>
				</table>
			</div>
		</div>

...
if ($tipo == "normal") {
	...
	$dados_rel = $_relatorioAjuda->MaterialLiberadoListagem($_POST);

		print "<legend>Listagem de materiais Liberados ( Analítico )</legend>";

		
		print "<div class='col-md-12'>";
		print "<p>Período : ".DataMysql::dataVisual($_dt_inicial)." a ".DataMysql::dataVisual($_dt_final)."</p>";
		print "<table style='width=50%' class='table table-bordered table-condensed' align='text-center'>";

		print "<tr>";
		print "<td>#</td>";
		print "<td>Nr. Liberação</td>";
		print "<td>Data Liberação</td>";
		print "<td>Municipio Liberção</td>";
		print "<td>Material</td>";
		print "<td>Qtd</td>";
		print "<td>Evento</td>";
		print "<td>Deposito Origem</td>";
		print "<td>Regiao DC</td>";
		print "<td>Nr. Regiao DC</td>";
		print "</tr>";

	foreach ($dados_rel as $key => $dado) {

		// var_dump($dado);
		// die();
		print "<tr>";
		print "<td>".($key+1)."</td>";
		print "<td>".$dado['id_liberacao']."</td>";
		print "<td>".DataMysql::dataVisual($dado['dataLibera'])."</td>";
		print "<td>".$dado['municipio']."</td>";
		print "<td>".$dado['singular']."</td>";
		print "<td>".$dado['quantidade']."</td>";
		print "<td>".$dado['evento']."</td>";
		print "<td>".$dado['deposito_origem']."</td>";
		print "<td>".$dado['nome_rdc']."</td>";
		print "<td>".$dado['id_rpm']."</td>";
		print "</td>";
		print "</tr>";

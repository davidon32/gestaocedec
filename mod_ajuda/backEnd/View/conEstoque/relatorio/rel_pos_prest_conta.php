	...
	$id_material = isset($_POST['id_material']) ? $_POST['id_material'] : "";
		...
		//print "<p align='center'><a href='".FuncaoBase::geraLink("ajuda", "relatorio", "form_busca_prest_contas")."' class='btn btn-primary'>Voltar</a></p>";
                ...
                print "<table class='table table-bordered'>";
                        ...
                        print "<th>Total Entrada Material</th>";
		...
		foreach ($entrada as $key => $value) {
                    ...
                    print "<tr>";
                        //print "<td></td>";
                        print "<td".$sinal.$cor.">".$value['id_produto']."</td>";
                        print "<td ".$sinal.$cor.">".$value['depDestino']."</td>";
                        print "<td".$sinal.$cor.">".$value['codProd']." - ".Unidade::PegaNomeId($value['codProd'])." - ".$value['origem']." </td>";
                        print "<td".$sinal.$cor.">( + ) ".$entrada."</td>";
                        print "<td".$sinal.$cor.">( - ) ".$totalTransferencia."</td>";
                        print "<td".$sinal.$cor.">( - ) ".$totalItem."</td>";
                        print "<td".$cor."> ".$sinal.$saldo."</td>";
                        print "</tr>";
                        $totalItem = 0;
                        $totalTransferencia = 0;
                }

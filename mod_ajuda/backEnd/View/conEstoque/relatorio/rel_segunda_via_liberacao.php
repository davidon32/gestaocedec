					...
					if($_numLiberacao != "" && $envia == "Pesquisar"){
						...
						print "<table class=\"table\">
								...
								<tr>
									...
									<td><a href=\"index.php?ac=itn&modulo=ajuda&secao=relatorio&acao=rel_liberacao_recibo&id=".$_numLiberacao."\" title=\"Segunda Via do Recibo de Liberacao\"><i class=\"icon-print\"></i></a></td>
								</tr>";
                        }else {

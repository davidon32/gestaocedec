...
if (empty($_POST)) {
    ...
    $listRel = $_relatorioAjuda->RelatorioListaMat([$id_material, $_id_deposito, $id_material]);
    ...
    foreach ($entrada as $key => $value) {
        ...
        $countTransf += count($transferencia);

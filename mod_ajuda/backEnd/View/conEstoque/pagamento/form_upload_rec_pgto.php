...
<div class="col-md-12">
    ...
    <div class="col-md-6">
        ...
        <br>
        <table class="table table-bordered" id="tb_Itens" align="left" border="0" cellspacing="0" cellpadding="0" >
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#txtNumPgto").change(function () {
            var form_data = new FormData();

            form_data.append("opcao", "busca_pgto");

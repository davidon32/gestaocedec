...
<?php
$analise_tec = new H_pedido_an_tecajuda_hModel();
$parecer_tec = $analise_tec->listAnalise($view[0]['id']);
?>
...
<?php
foreach ($parecer_tec as $key => $parecer) {

    print "<tr>
                                        <td>" . $key . "</td>
                                        <td>" . DataMysql::dataCompletaVisual($parecer['data_parecer']) . "</td>

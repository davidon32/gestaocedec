...
<script src="/vendor/tree/js/bootstrap-tree.js"></script>
<?php
...
<div class='col-md-12'>
    ...
    <div id="html1">
        <ul>
            <li data-jstree='{"opened":false,"selected":true}'> Processo Nº - <?=$view[0]['numero']."/".substr($view[0]['data_entrada_sistema'], 0, 4)?> - <?= DataMysql::dataVisual($view[0]['data_entrada_sistema'])?>
                <ul>
                    <li data-jstree='{"disabled":true}'> Dados Gerais</li>
                    asas
            ...
            <div class="col-md-12" id="dados_gerais">

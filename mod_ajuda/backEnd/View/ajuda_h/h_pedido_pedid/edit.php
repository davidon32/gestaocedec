 ...
 <div class="col-md-12 text-center">
     ...
     <table class="table table-bordered table-condensed">
         ...
         foreach ($materiais as $key => $material) {
             ...
             print "<td>";
                print "<a href='index.php".FuncaoBase::geraLink('ajuda', 'peido_itens', 'edit')."'><img src='/core/imagem/editar.png'></a>";
                print "<a href='index.php".FuncaoBase::geraLink('ajuda', 'peido_itens', 'delete')."'><img src='/core/imagem/delete.png'></a>";

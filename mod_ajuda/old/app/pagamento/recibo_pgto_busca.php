					...
					if($envia == "Pesquisar" && $_n_recibo != ""){
						...
						print "<table class=\"table\">
								...
								<tr>
									...
									<td><a href=\"index.php?modulo=ajuda&secao=relatorio&acao=rel_recibo_pgto&nlib=".$_n_recibo."\" title=\"Segunda Via do Recibo de Pagamento\"><i class=\"icon-print\"></i></a></td>
								</tr>";

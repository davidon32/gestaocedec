...
<div class="container">
    ...
    <div align="center" id="cabecalho"><a class='btn' href='index.php?token=<?=hash('sha256', md5(VERSAO).date('dmY'));?>&ac=&modulo=ajuda&secao=liberacao&acao=rel_busca_resumo'>Voltar</a><br><br></div>

  ...
  <body>
  	...
  	<?php include_once 'menu.ajuda.php';?>
			...
			<div class="col-md-1 text-center"></div>
	  		<div class="col-md-8">
	  			<a href="?modulo=ajuda&secao=liberacao&acao=busca" class="btn btn-primary">Voltar</a>
	  			<!-- corpo -->
	  				<br>
	  				<br>
	  				<form action="?modulo=ajuda&secao=liberacao&acao=pedido" method="POST" name="frmBusca">
	  				<h4>Formulário de solicitação de Ajuda Humanitária (Exceto Água para Consumo Humano)</h4>
	  				<div class="col-md-10">
		  				<label>Nome do Município: <?=$dadosMunicipio['nome'];?></label>
	  				...
	  				<div class="col-md-12 text-center">
	  					<br>
	  					<input class="btn btn-primary" type="submit" name="btn" id="btn" value="Gravar">
	  				</div>

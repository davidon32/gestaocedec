...
class MarcaConEstoqueModel extends Model {
    ...
    function __construct() {
        ...
        self::$model = $this->Tabela('aju_cmarca');
    ...
    public static function listaExportExcel($id = null) {
        ...
        if (!empty($id)) {
            ...
            $filtro = " where aju_cmarca.id_marca = " . $id . " ";
        }

        $sql = "select aju_cmarca.id_marca,
                    aju_cmarca.nome
                    FROM aju_cmarca
                    " . $filtro . "
                    order by aju_cmarca.nome";
    ...
    public static function gravar(array $dados) {
        ...
        $sql = "INSERT INTO aju_cmarca (nome 
) VALUES (:nome 
)";
...
aju_cmarca.nome
    ...
    public function paginacao($start, $regPorPagina) {
        ...
        $stmt = $con->prepare("SELECT aju_cmarca.id_marca,
aju_cmarca.nome
                                FROM aju_cmarca
    ...
    public static function delete($id) {
        ...
        $sql = "DELETE FROM aju_cmarca WHERE id_marca = " . $id;

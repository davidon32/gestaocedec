 ...
 * 																					*
 * 	Classe para manipulacao de fornecedor Controle Estoque 											*
 * 																					*
...
class FornecedorEstoqueModel extends DataMysql {
    # lista fornecedor
    ...
    public static function gravar(array $dados) {
        ...
        $sql = "INSERT INTO aju_fornecedor (razao,
                                                cpfcnpj,
                                                endereco,
                                                tel)
                                    		      VALUES (:nome,
     ...
     * View fornecedor
     */
    public static function view($fornecedor_id) {
    ...
    public function paginacao($start, $regPorPagina){
        $con = Conexao::getInstance();
            ...
            $stmt = $con->prepare("SELECT id_fornecedor,
                                    razao,
                                    cpfcnpj,
                                    endereco,
                                    tel

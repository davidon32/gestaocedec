...
class Unidade_medConEstoqueModel extends Model {
    ...
    private $table = "aju_cunidade_med";
    public static $model;
    private static $mod;
    private $marca;
    private static $con;
 ...
 public function getNome(){
    ...
    #################  CONSTRUTOR ##################
     function __construct() {
         ...
         self::$model = $this->Tabela('aju_cunidade_med');
   ...
   # lista {$model}
    ...
    public static function gravar(array $dados) {
        ...
        $sql = "INSERT INTO aju_cunidade_med (nome 
) VALUES (:nome 
)";
    ...
    public static function edit(array $dados) {
        ...
        $sql = "UPDATE aju_cunidade_med SET 
        nome= :nome
    ...
    public static function view($id_unidade_med) {
        ...
        $sql = "SELECT aju_cunidade_med.id_unidade_med,
aju_cunidade_med.nome
    ...
    public function paginacao($start, $regPorPagina){
        $con = Conexao::getInstance();
            ...
            $stmt = $con->prepare("SELECT aju_cunidade_med.id_unidade_med,
aju_cunidade_med.nome
                                FROM aju_cunidade_med
    ...
    public static function delete($id) {
        ...
        $sql = "DELETE FROM aju_cunidade_med WHERE id_unidade_med = " . $id;

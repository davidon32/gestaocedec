 ...
 public function getNome(){
    ...
    #################  CONSTRUTOR ##################
     function __construct() {
         ...
         self::$model = $this->Tabela('aju_ccategoria');
   ...
   # lista {$model}
    ...
    public static function gravar(array $dados) {
        ...
        $sql = "INSERT INTO aju_ccategoria (nome 
) VALUES (:nome 
)";
    ...
    public static function view($id_categoria) {
        ...
        $sql = "SELECT aju_ccategoria.id_categoria,
aju_ccategoria.nome
                              FROM aju_ccategoria
    ...
    public function paginacao($start, $regPorPagina){
        $con = Conexao::getInstance();
            ...
            $stmt = $con->prepare("SELECT aju_ccategoria.id_categoria,
aju_ccategoria.nome
                                FROM aju_ccategoria
    ...
    public static function delete($id) {
        ...
        $sql = "DELETE FROM aju_ccategoria WHERE id_categoria = " . $id;

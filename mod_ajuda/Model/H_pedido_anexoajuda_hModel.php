 ...
 *
 * 	Classe para manipulacao da tabela aju_h_pedido_anexo										*
 * 																					*
...
class H_pedido_anexoajuda_hModel extends Model {

    
    private $table = "aju_h_pedido_anexo";
    public static $model;
    private static $mod;
    private $marca;
    private static $con;
 ...
 public function getNome_arquivo(){
    ...
    #################  CONSTRUTOR ##################
     function __construct() {
         ...
         self::$model = $this->Tabela('aju_h_pedido_anexo');
   ...
   # lista {$model}
    ...
    ################  Atualizar dados h_pedido_anexo  ###################
    ...
    public static function edit(array $dados) {
        ...
        $sql = "UPDATE aju_h_pedido_anexo SET 
        id_pedido= :id_pedido,
...
$result->bindValue(":nome_arquivo", $dados['nome_arquivo']);
            ...
            #Log::GravaLog("Atualizar Cadastro de H_pedido_anexo : " . $dados['nome'] . " " . $_COOKIE['seguranca']['login'], "aju_log");
     ...
     * View Marca
     */
    public static function view($id_h_pedido_anexo) {

        $con = Conexao::getInstance();

        $fornecedor = "";

        $sql = "SELECT aju_h_pedido_anexo.id,
aju_h_pedido_anexo.id_pedido,
aju_h_pedido_anexo.nome_arquivo
                              FROM aju_h_pedido_anexo
                              
                              WHERE id_h_pedido_anexo = " . $id_h_pedido_anexo;
        ...
        try {
            ...
            while ($linha = $result->fetch(PDO::FETCH_ASSOC)) {
                $h_pedido_anexo = $linha;
            }

           $model = self::$model;
            return array($h_pedido_anexo, $model);
        } catch (Exception $e) {
            return $e->getMessage() . "Erro ao inserir H_pedido_anexo";
        }
    }
    ...
    public function paginacao($start, $regPorPagina){
        $con = Conexao::getInstance();
            ...
            $stmt = $con->prepare("SELECT aju_h_pedido_anexo.id,
aju_h_pedido_anexo.id_pedido,
aju_h_pedido_anexo.nome_arquivo
                                FROM aju_h_pedido_anexo
                                
                                ORDER By id_h_pedido_anexo DESC LIMIT $start, $regPorPagina");
            $stmt->execute();
    ...
    public static function delete($id) {
        ...
        try {
            ...
            return $e->getMessage() . "Erro Deletar H_pedido_anexo !";
        }
    }
    ...
    /**
     * Lista h_pedido_anexo
     */
    public function listah_pedido_anexos() {

 ...
 public function getNome(){
    ...
    #################  CONSTRUTOR ##################
     function __construct() {
         ...
         self::$model = $this->Tabela('aju_ctp_pedido');
   ...
   # lista {$model}
    ...
    public static function gravar(array $dados) {
        ...
        $sql = "INSERT INTO aju_ctp_pedido (nome 
) VALUES (:nome 
)";
    ...
    public static function view($id_tp_pedido) {
        ...
        $sql = "SELECT aju_ctp_pedido.id_tp_pedido,
aju_ctp_pedido.nome
                              FROM aju_ctp_pedido
    ...
    public function paginacao($start, $regPorPagina){
        $con = Conexao::getInstance();
            ...
            $stmt = $con->prepare("SELECT aju_ctp_pedido.id_tp_pedido,
aju_ctp_pedido.nome
                                FROM aju_ctp_pedido
    ...
    public static function delete($id) {
        ...
        $sql = "DELETE FROM aju_ctp_pedido WHERE id_tp_pedido = " . $id;

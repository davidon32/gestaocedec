        ...
        if ((!isset($a)) || ($a == null)) {
            ...
            for ($i = 0; $i < count($a); $i++) {
                print "<tr>
							...
							<td align='center'><a class=\"btn btn-info\" href=\"".FuncaoBase::geraLink("ajuda", "conestoque", "remove_item", array('item'=>$i, 'r'=>1))."\" title=\"Remove Item da Liberação\">Remover</a></td>
							</tr>";
            }
            print "</table>";
        }

...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="alert alert-danger text-center">
            ...
            <h4>O campos destacados em vermelho são preenchidos automaticamente, e são buscados do seu cadastro de COMPDEC, por acaso estiver em branco ou incompleto, volte para o seu <a href='<?= FuncaoBase::geraLink('compdec', 'compdec', 'compdec')?>'>Cadastro de Compdec</a> e Altere ou complete os dados. !</h4>
    ...
    <div class='col-md-12'>
        ...
        <div class='row'>
            <div class='col-md-12'>
                ...
                <div class="col-md-6 input-group has-error has-feedback">
        ...
        <div class='row'>
            ...
            <div class='row'>
                <div class='col-md-12'>
                    ...
                    <div class="col-md-3 input-group has-error has-feedback">

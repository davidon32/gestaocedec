	...
	<body>
      ...
      <div class="row-fluid">
          ...
          <div class="span10"  style="min-height: 700px;">
          	...
          	<a href="?secao=adm&acao=buscausuex" class="btn" title="Ativação do Cadatro de Compdec">Ativar Cadastro Usuario Externo</a>
          	<br>
          	<a href="?secao=adm&acao=reset" class="btn" title="Ativação do Cadatro de Compdec">Resetar Senha</a>
          	<br>
          	<a href="?secao=adm&acao=update" class="btn" title="Ativação do Cadatro de Compdec">Alterar Dados Cadastrais Usuario Externo</a>

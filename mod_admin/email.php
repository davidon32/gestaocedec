<?php require("plugins/PHPMailer/class.phpmailer.php");
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$mail->AddAddress('demetrio.passos@defesacivil.mg.gov.br', 'Demetrio Silva Passos');
$mail->AddAddress('zinhoflag1@gmail.com');

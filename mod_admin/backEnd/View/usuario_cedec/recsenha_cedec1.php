...
<div style="width:600px; margin:0 auto;" class="fix-altura">
    ...
    <br>
    <?php
    $helper->form(FuncaoBase::geraLink("equipe", "usuario", "recsenha_cedec"), "POST", "resSenha", "");

    $helper->input("text", "usuario", "Nome do Usuario", false, array('class' => 'form-control'));
    print "<br>";
    $helper->input("text", "email", "O sistema enviará Email Recuperação Senha", array('readonly'=>'readonly'), array('class' => 'form-control'));

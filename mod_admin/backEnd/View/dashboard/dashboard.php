...
<div class="row">
    <div class="col-md-12">
    <legend>Cadastros Municípios</legend>
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?=number_format(($dados['atualizado']*100)/853, 2);?><small>%</small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?=number_format(($dados['desatualizados']*100)/853, 2);?><small>%</small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->

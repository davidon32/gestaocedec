...
function contarCaracteres(box, valor, campospan) {
    ...
    document.getElementById(campospan).innerHTML = "Voc̻ ainda pode digitar " + conta + " caracteres";
    if (box.length >= valor) {
        document.getElementById(campospan).innerHTML = "Opss.. voc̻ ṇo pode mais digitar..";
...
function caracterestante(textarea, span, length) {

    $("#" + textarea).keyup(function () {
        $('#' + span).text(" ( Caracteres Restantes :" +(length - $("#" + textarea).val().length)+")");
    });
}

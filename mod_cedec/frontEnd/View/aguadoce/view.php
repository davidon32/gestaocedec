...
<body>
    <div class="col-sm-12 text-center">
        <img width="100" src="/core/imagem/logo-agua-doce.png">
        <br><br>
    </div>
   <div class="container">
    <div class="col-sm-3 view"></diV>
    <div class="col-sm-6" align="center">
        <img width="350" src="/anexo/def_civil_agora/<?=$lista[0]['imagem1'];?>" class="img-rounded img-responsive">
        <br>
        <br>
    </diV>
    <div class="col-sm-3 view"></diV>

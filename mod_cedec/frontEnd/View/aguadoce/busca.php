...
<div class="col-lg10 col-xs-12">
    ...
    <a class="btn btn-primary" href="?modulo=cedec&controller=aguadoce&action=index">Voltar</a>
    <br>
    <br>
...
if($btn == 'pesquisa'){
    $lista = $aguaDoce->lista($param, $texto, null);
}
...
<table class="table">
    ...
    <?php foreach ($lista as $key => $value) {
       ...
       print "<td style='padding:0;'><ul class='imgHover'>
                    <li style='padding: 0; margin:0;'><img width='50px;' src='anexo/aguadoce/".$value['imagem1']."'>
                        <span class='large'>
                            <img width='300px;' src='anexo/aguadoce/".$value['imagem1']."' class='large-image' alt='adventure' >
                        </span>
                    </li></ul>
                    </td>";
       print "<td $status>".$aguaDoce->status($value['status1'])."</td>";
       print "<td>
                <a href='?modulo=cedec&controller=aguadoce&action=editar&id=".$value['id']."' id='lkEditar'><img src='core/imagem/editar.png' title='Editar Lançamento'></a>
                ...
                <a href='?modulo=cedec&controller=aguadoce&action=lista&id=".$value['id']."''><img src='core/imagem/view.png' title='Visualizar Lançamento'id='lkVisualizar'></a>";

...
<html>
    ...
    <div style="width:600px; margin:0 auto;">
        ...
        <legend>Troca de Senha <span style="color:red; font-weight: bold">Cedec</span></legend>
        ...
        <form action="#" method="POST" name="frm_trocasenha">
            ...
            <br />
            <button type="submit" class="btn btn-primary" name="btn_trocasenha" id="btn_trocasenha" value="alterar">Trocar Senha</button>
        </form>
    </div>
    <?php
    $tr_senha = isset($verificaTrSenhaCedec) ? $verificaTrSenhaCedec : "";
    ...
    if ($envia_troca == "alterar") {
        ...
        if (isset($tr_senha['troca'])) {
            ...
            $dados = $usuario->getResetUsuario($tr_senha['reset']);
                ...
                if (empty($externo)) {
                    ...
                    if ($campo_branco) {
                        ...
                        if ($_login->TrocaSenha($dados['login'], $senha_nova)) {
                            ...
                            //var_dump($_login->TrocaSenha($dados['login'], $senha_nova));
                            
                            /* remove o hash e o reset do usuario*/
                            Usuario::normAcesso($dados['login']);

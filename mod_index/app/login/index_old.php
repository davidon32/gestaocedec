<?php include_once PATH.'/core/system/config/config.inc.php';
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html">SGE<b>CEDEC</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Entre com seu <b>usuário</b> e <b>senha</b> para acesso ao Sistema</p>

    <form action="index.php?secao=login&acao=logar" method="post" id="form1" name="form1">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Password" name="senha" id="senha" size="15">
...
<!--     <div class="social-auth-links text-center">
    ...
    <a href="index.php?secao=login&acao=recsenha">Esqueci minha senha</a><br>

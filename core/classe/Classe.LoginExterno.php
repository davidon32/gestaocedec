		...
		cedec_municipio.nome
			...
			window.location = "index.php";
                ...
                if ($linha['trsenha'] == 1) {
                    ...
                    //}else {
                    return array('page'=> 'index', 'id_municipio' => $linha['id_municipio']);
                    //}
                }
            } else {
                return "mozila";
...
#@ pega o nome do usuario 
    ...
    /**
     * busca cpf em branco do coordenador
     */
    public static function buscaCPF($id_municipio) {
        $con = Conexao::getInstance();

        $linha = array();

        $sql = "SELECT cpf FROM com_eq_comdec where funcao = 'Coordenador'
                and cpf is null
